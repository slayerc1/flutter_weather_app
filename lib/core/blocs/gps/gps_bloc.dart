...
class GpsBloc extends Bloc<GpsEvent, GpsState> {
  ...
  Future<void> _init() async {
    ...
    add(GpsAndPermissionEvent(isGpsEnable: gpsInitStatus[0], isGpsPermissionGranted: gpsInitStatus[1]));
  }
  ...
  Future<bool> _checkGpsStatus() async {
    ...
    gpsServiceSubscription = Geolocator.getServiceStatusStream().listen((event) {
      ...
      add(GpsAndPermissionEvent(isGpsEnable: isEnabled, isGpsPermissionGranted: state.isGpsPermissionGranted));
    });
